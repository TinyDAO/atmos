...
export const CITIES: City[] = [
  ...
  },
  {
    ...
    timezone: 'America/Los_Angeles',
    utcOffsetMinutes: -480,
    description: 'The City by the Bay. Fog, hills, and Pacific gateway innovation.',
  ...
  },
  {
    ...
    utcOffsetMinutes: 480,
    description: 'Pearl of the Orient. Bustling capital on Manila Bay, gateway to 7,000 islands.',
    gradient: 'from-amber-600 via-orange-500 to-rose-500',
    image: '/images/cities/manila.jpg',
  },
  {
    id: 'guangzhou',
    name: 'Guangzhou',
    ...
    timezone: 'Asia/Shanghai',
    utcOffsetMinutes: 480,
    description: 'Canton and the Pearl River heart. Trade, dim sum, and southern dynamism.',
    gradient: 'from-emerald-600 via-teal-500 to-cyan-600',
    image: '/images/cities/guangzhou.jpg',
    moji: 'https://tianqi.moji.com/weather/china/guangdong/guangzhou',
    cma: 'https://weather.cma.cn/web/weather/59287.html',
    hbt: 'http://wechat.hbt7.com/mhweixin/app/common/airportWeather/searchWeather?city=%E5%B9%BF%E5%B7%9E',
  },
  {
    id: 'qingdao',
    name: 'Qingdao',
    ...
    timezone: 'Asia/Shanghai',
    utcOffsetMinutes: 480,
    description: 'Yellow Sea port and beer city. Beaches, Tsingtao heritage, and Shandong cool.',
    gradient: 'from-sky-600 via-blue-500 to-indigo-600',
    image: '/images/cities/qingdao.jpg',
    moji: 'https://tianqi.moji.com/weather/china/shandong/qingdao',
    cma: 'https://weather.cma.cn/web/weather/54857.html',
    hbt: 'http://wechat.hbt7.com/mhweixin/app/common/airportWeather/searchWeather?city=%E9%9D%92%E5%B2%9B',
  },
  {
    id: 'panama-city',
    name: 'Panama City',
